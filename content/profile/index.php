        ...
        <div class="col-md-4 ">
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control" id="numero_telephone" name="numero_telephone" value="<?php echo $user->phone ?>">
                </div>
                <div class="form-group">
                    <label for="adresse">Adresse:</label>
                    <input type="text" class="form-control" id="adresse" name="adresse" value="<?php echo $user->address ?>">
                </div>
                <div class="form-group">
                    <label for="adresse_mail">Adresse mail:</label>
                    <input type="text" class="form-control" id="adresse_mail" name="adresse_mail" value="<?php echo $user->email ?>" disabled>
                </div>
                <div class="form-group">
